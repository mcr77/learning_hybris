		...
		<table class="orderListTable">
			...
			<c:forEach items="${searchPageData.results}" var="order">
				<tr>
					...
					<td headers="header5">
						<c:set var="orderCode" value="${order.purchaseOrderNumber}?storeId=${order.store.storeId}&transactionDate=${order.formattedBusinessDayDate}&transactionIndex=${order.transactionIndex}" scope="request"/>
