...
public class SAPInitiativeValueProvider implements CollectionOperandValueProvider<BTGSAPInitiativeOperandModel>
{
	...
	@Override
	public Object getValue(final BTGSAPInitiativeOperandModel operand, final UserModel user, final BTGConditionEvaluationScope scope)
	{
		...
		if (user != null){
			...
			if (userId != null){
				if (sessionService.getAttribute(INITIATIVES_PREFIX + userId) != null){
					...
					List<SAPInitiative> initiativesForBP;
