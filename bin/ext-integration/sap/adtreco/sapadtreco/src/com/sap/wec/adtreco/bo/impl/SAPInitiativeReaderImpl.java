...
public class SAPInitiativeReaderImpl extends BusinessObjectBase implements SAPInitiativeReader
{
	...
	public List<SAPInitiative> searchInitiatives(final String search)
	{
		...
		/*
		 * final String filterStatus = "(LifecycleStatus/StatusCode" + EQ_UTF8 + IN_PREPARATION + QUOT_UTF8 + OR_UTF8 +
		 * "LifecycleStatus/StatusCode" + EQ_UTF8 + RELEASED + QUOT_UTF8 + ")";
		 */
	...
	public List<SAPInitiative> searchInitiativesForBP(final String businessPartner)
	{
