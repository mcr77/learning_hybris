...
public class DataHubInitialLoadHandler
{
	...
	public Collection<DataHubTransferLog> executeInitialLoad()
	{
				...
				.entrySet())
		{
			...
			// As deletion of all items in data hub is not yet fully supported, it has to be provided in one of the next releases. 
			...
			final DataHubTransferLog transferLog = dataHubTransferHandler.invokeTransfer(code, models,
					dataHubConfigurationEntry.getValue(), false);
