...
import de.hybris.platform.sap.core.configuration.rfc.impl.DefaultRFCDestination;
...
public class DefaultSAPConfigurationService implements SAPConfigurationService
{
	...
	public RFCDestination getRFCDestination()
	{
		if (rfcDestination == null)
		{
			...
			{
				((DefaultRFCDestination) rfcDestination).setRfcDestinationName(rfcDestinationName);
			}
			else
			{
				((DefaultRFCDestination) rfcDestination).setRfcDestinationName(ConfigurationConstants.DEFAULT_RFC_DESTINATION_NAME);
			}
		}
