...
public class DefaultJCoManagedConnectionFactory implements JCoManagedConnectionFactory
{
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.hybris.platform.sap.core.bol.jco2.RFCManagedConnectionFactory#getManagedConnection(java.lang.String)
	 */
	@Override
	public JCoConnection getManagedConnection(final String connectionName, final String callerId)
	{
		...
		final JCoConnection managedConnection = (JCoConnection) getGenericFactory().getBean(
				connectionDefinitions.get(connectionName));
