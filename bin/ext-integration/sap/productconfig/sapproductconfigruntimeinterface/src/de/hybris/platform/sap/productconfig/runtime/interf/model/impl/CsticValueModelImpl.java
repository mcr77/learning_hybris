...
public class CsticValueModelImpl extends BaseModelImpl implements CsticValueModel
{
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.hybris.platform.sap.productconfig.runtime.interf.model.CsticValueModel#isSelectable()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.hybris.platform.sap.productconfig.runtime.interf.model.CsticValueModel#setSelectable(boolean)
	 */
	@Override
