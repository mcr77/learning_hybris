...
public class MessageMappingRulePatternTest extends TestCase {
	...
	public static MessageMappingRule.Pattern clonePattern(
			MessageMappingRule.Pattern obj) {
		return new MessageMappingRule.Pattern(ObjectTestUtil.cloneString(obj
				.getBeClass()), ObjectTestUtil.cloneString(obj.getBeNumber()),
				ObjectTestUtil.cloneString(obj.getBeSeverity()),
				ObjectTestUtil.cloneString(obj.getBeV1()),
				ObjectTestUtil.cloneString(obj.getBeV2()),
				ObjectTestUtil.cloneString(obj.getBeV3()),
				ObjectTestUtil.cloneString(obj.getBeV4()));
	}
	...
	public void testConstructorWithValues() {
		...
		MessageMappingRule.Pattern pattern = new MessageMappingRule.Pattern(
				BE_CLASS, BE_NUMBER, BE_SEVERITY);
	...
	public void testConstructorWithValuesAndArgs() {
		...
		MessageMappingRule.Pattern pattern = new MessageMappingRule.Pattern(
				BE_CLASS, BE_NUMBER, BE_SEVERITY, BE_V1, BE_V2, BE_V3, BE_V4);
	...
	public void testConstructorWithAllStars() {
		...
		MessageMappingRule.Pattern pattern = new MessageMappingRule.Pattern(
				BE_STAR, BE_STAR, BE_STAR, BE_STAR, BE_STAR, BE_STAR, BE_STAR);
	...
	public static MessageMappingRule.Pattern //
			...
			sample = new MessageMappingRule.Pattern(BE_CLASS, BE_NUMBER,
					BE_SEVERITY, BE_V1, BE_V2, BE_V3, BE_V4), //
			sampleEqual = clonePattern(sample), //
			sampleEqual2 = clonePattern(sampleEqual), //
			oDiffCl = new MessageMappingRule.Pattern("Z" + BE_CLASS, BE_NUMBER,
					BE_SEVERITY), //
			oDiffNum = new MessageMappingRule.Pattern(BE_CLASS, "999",
					BE_SEVERITY), //
			oDiffSever = new MessageMappingRule.Pattern(BE_CLASS, BE_NUMBER,
					"I"), //
			oDiffV1 = new MessageMappingRule.Pattern(BE_CLASS, BE_NUMBER,
					BE_SEVERITY, "Z" + BE_V1, BE_V2, BE_V3, BE_V4), //
			oDiffV2 = new MessageMappingRule.Pattern(BE_CLASS, BE_NUMBER,
					BE_SEVERITY, BE_V1, "Z" + BE_V2, BE_V3, BE_V4), //
			oDiffV3 = new MessageMappingRule.Pattern(BE_CLASS, BE_NUMBER,
					BE_SEVERITY, BE_V1, BE_V2, "Z" + BE_V3, BE_V4), //
			oDiffV4 = new MessageMappingRule.Pattern(BE_CLASS, BE_NUMBER,
					BE_SEVERITY, BE_V1, BE_V2, BE_V3, "Z" + BE_V4), //
			sample2 = new MessageMappingRule.Pattern("Z" + BE_CLASS, "888", "A");

	public static MessageMappingRule.Pattern[] //
			equalSet = { sample, sampleEqual, sampleEqual2 }, //
			emptySet = { empty, emptyIdentical }, //
			differntSet = { oDiffCl, oDiffNum, oDiffSever, oDiffV1, oDiffV2,
					oDiffV3, oDiffV4, sample2 };
	...
	public static MessageMappingRule.Pattern //
	sampleArgxxxx = new MessageMappingRule.Pattern(sample.beClass,
			sample.beNumber, sample.beSeverity), //
			sampleArgxxx1 = new MessageMappingRule.Pattern(sample.beClass,
					sample.beNumber, sample.beSeverity, null, null, null, BE_V4), //
			sampleArgxx1x = new MessageMappingRule.Pattern(sample.beClass,
					sample.beNumber, sample.beSeverity, null, null, BE_V3, null), //
			sampleArgx1xx = new MessageMappingRule.Pattern(sample.beClass,
					sample.beNumber, sample.beSeverity, null, BE_V2, null, null), //
			sampleArg1xxx = new MessageMappingRule.Pattern(sample.beClass,
					sample.beNumber, sample.beSeverity, BE_V1, null, null, null), //
			sampleArgxx11 = new MessageMappingRule.Pattern(sample.beClass,
					sample.beNumber, sample.beSeverity, null, null, BE_V3,
					BE_V4), //
			sampleArgx1x1 = new MessageMappingRule.Pattern(sample.beClass,
					sample.beNumber, sample.beSeverity, null, BE_V2, null,
					BE_V4), //
			sampleArg1xx1 = new MessageMappingRule.Pattern(sample.beClass,
					sample.beNumber, sample.beSeverity, BE_V1, null, null,
					BE_V4), //
			sampleArg11xx = new MessageMappingRule.Pattern(sample.beClass,
					sample.beNumber, sample.beSeverity, BE_V1, BE_V2, null,
					null), //
			sampleArg1111 = new MessageMappingRule.Pattern(sample.beClass,
					sample.beNumber, sample.beSeverity, BE_V1, BE_V2, BE_V3,
					BE_V4);
	...
	public void testMatchCNS_Stars() {
		// null case too
		assertTrue(new MessageMappingRule.Pattern(null, "001", "W").matchCNS(
				"arbitrary", "001", "W"));

		// empty case too
		assertTrue(new MessageMappingRule.Pattern("class", "", "W").matchCNS(
				"class", "001", "W"));

		// '*' case too
		assertTrue(new MessageMappingRule.Pattern("class", "001", "*")
				.matchCNS("class", "001", "W"));
	}
	...
	public void testPatternMatchCNS_NullRule() {
		MessageMappingRule.Pattern o = new MessageMappingRule.Pattern(null,
				null, null);
		assertTrue(o.matchCNS("class", "001", "W"));
	}
	...
	public void testPatternMatchCNS_3Concrete() {
		MessageMappingRule.Pattern o = new MessageMappingRule.Pattern("class",
				"001", "W");
		assertTrue(o.matchCNS("class", "001", "W"));
	}
	...
	public void testPatternMatchVARS_Stars() {
		assertTrue(sampleArgxxxx.matchVARS("anything1", "anything2",
				"anything3", "anything4"));
	}

	@Test
	public void testPatternMatchVARS_VarPositions() {
		assertTrue(sampleArg1xxx.matchVARS(BE_V1, "anything2", "anything3",
				"anything4"));
		assertTrue(sampleArgx1xx.matchVARS("anything2", BE_V2, "anything3",
				"anything4"));
		assertTrue(sampleArgxx1x.matchVARS("anything2", "anything3", BE_V3,
				"anything4"));
		assertTrue(sampleArgxxx1.matchVARS("anything2", "anything3",
				"anything4", BE_V4));
	}
	...
	public void testPatternMatch() {
		assertTrue(sample.match(BE_CLASS, BE_NUMBER, BE_SEVERITY, BE_V1, BE_V2,
				BE_V3, BE_V4));
	}
