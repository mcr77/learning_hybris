...
public class HeaderMapperJCoRecTest extends JCORecTestBase
{
	...
	{
		super.setUp();
		cut = genericFactory.getBean(SapordermgmtbolConstants.ALIAS_BEAN_HEADER_MAPPER);

		if (esError == null)
		{
			readTablesFromRepository();
		}
		tc = (TransactionConfiguration) genericFactory.getBean(SapordermgmtbolConstants.ALIAS_BO_TRANSACTION_CONFIGURATION);
