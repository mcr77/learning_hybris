...
public class InitBasketImpl implements InitBasket
{
	...
	static final protected Log4JWrapper sapLogger = Log4JWrapper.getInstance(InitBasketImpl.class.getName());

	@Override
	public void init(final Basket basket, final String soldToId, final String contactId)
	{
		...
		try
		{
			...
			//updateAndReadBasket(basket);


		}
		catch (final BusinessObjectException e)
		{
			throw new ApplicationBaseRuntimeException("SalesDocument could not be initialized", e);
	...
	private void updateAndReadBasket(final Basket basket) throws CommunicationException
	{
		basket.update();
	...
	private void initEmptyBasket(final Basket basket, final String soldToId, final String contactId) throws CommunicationException
	{
		final PartnerList partnerList = (PartnerList) genericFactory.getBean(SapordermgmtbolConstants.ALIAS_BEAN_PARTNER_LIST);
	...
	@Override
	public void initPartnerList(final PartnerList partnerList, final String soldToId, final String contactId)
	{
	 ...
	 * @param partnerId
	 */
	protected void addPartnerData(final PartnerList partnerList, final String partnerFunction, final String partnerId)
	{
