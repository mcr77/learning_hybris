...
abstract public class TextMapper extends BaseMapper
{
	...
	public void init()
	{
		if (configTextId == null)
		{
			throw new IllegalStateException("Ilegal text ID " + configTextId);
		}
		if (configLangIso == null)
		{
			throw new IllegalStateException("Ilegal ISO langauge code " + configLangIso);
		}
	}
