...
/**
 * Shopping basket for internet sales. The well known methaphor of a shopping basket ist implemented using this class.
 * The basket consist of several items, and header information.
 * 
 */
...
public class BasketImpl extends SalesDocumentImpl implements Basket
{
	...
	{
		final boolean updateMissing = (basketOrderConsistency != null && basketOrderConsistency.isUpdateMissing())
	...
	private boolean assureConsistency()
	{
		...
		final boolean isUpdateNeeded = basketOrderConsistency.assureConsistentData(this);
	...
	public void release() throws CommunicationException
	{
		...
		// release backend object via retrieving a newly initialized backend object
		try
		{
