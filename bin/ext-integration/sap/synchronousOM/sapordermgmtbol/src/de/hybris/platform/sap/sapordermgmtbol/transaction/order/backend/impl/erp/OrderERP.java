 ...
 */
@BackendType("ERP")
public class OrderERP extends SalesDocumentERP implements OrderBackend
{

	private static final Log4JWrapper sapLogger = Log4JWrapper.getInstance(OrderERP.class.getName());
