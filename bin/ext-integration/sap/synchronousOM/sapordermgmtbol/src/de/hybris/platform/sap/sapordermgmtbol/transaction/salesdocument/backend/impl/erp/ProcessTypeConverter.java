...
public class ProcessTypeConverter
{
	...
	private static final String EXPORT_PARAMETER_PROCESSTYPE = "EV_AUART_SPR";
	private static final String INPUT_PARAMETER_LANGUAGE = "IV_LANGUAGE";
	private static final String INPUT_PARAMETER_PROCESSTYPE = "IV_AUART";
	private static final String FM_FOR_CONVERSION = "ERP_WEC_CUST_AUART_TO_SPR";
