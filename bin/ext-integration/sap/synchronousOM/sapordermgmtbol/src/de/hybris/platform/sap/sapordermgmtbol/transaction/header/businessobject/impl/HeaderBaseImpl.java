...
public class HeaderBaseImpl extends SimpleHeaderImpl implements HeaderBase
{
	...
	// IsaLocation.getInstance(HeaderBase.class.getName());

	protected boolean changeable; // Document changeable in general (R/3
	// documents are not changeable yet)
	 ...
	 * #addPredecessor(com.sap.wec.app.common.module.transaction.businessobject .interf.ConnectedDocument)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject.interf .HeaderBase#getDeliveryPriority()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject.interf .HeaderBase#getNetValueWOFreight()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject.interf .HeaderBase#getPredecessorList()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject.interf .HeaderBase#getProcessTypeDesc()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject.interf .HeaderBase#getPurchaseOrderExt()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject.interf .HeaderBase#getReqDeliveryDate()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject.interf .HeaderBase#setChangeable(boolean)
	 */
	@Override
	 ...
	 * 
	 * @see de.hybris.platform.sap.sapordermgmtbol.transaction.header.businessobject.interf
	 * .HeaderBase#setChangedAt(java.lang.String)
	 */
	...
	{
		final StringBuffer buf = new StringBuffer(STRING_BUFFER_INIT_SIZE_FOR_TOSTRING);
