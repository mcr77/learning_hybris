...
public interface Item extends ItemBase, StatusObject
{
	...
	/**
	 * Get the value of a flag indicating, whether creation of the IPC configuration in the back end is required.
	 * 
	 * @return prepareConfigurationRequired
	 */
	public boolean isPrepareConfigurationRequired();

	/**
	 * This method sets a flag indicating , that creation of the IPC configuration in the back end is required. This is
	 * relevant for decoupled mode only.
	 * 
	 * @param prepareConfigurationRequired
	 *           true when required
	 */
	public void setPrepareConfigurationRequired(boolean prepareConfigurationRequired);

	/**
	 * Get the value of a flag indicating, whether configuration is updated in the configuration UI.
	 * 
	...
	/**
	 * This method sets a flag indicating , that configuration is updated in the configuration UI.
	 * 
	 * @param configurationUpdated
	 *           true when updated
	 */
