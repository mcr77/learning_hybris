...
public class ItemSalesDoc extends ItemBaseImpl implements Item
{
	...
	//
	protected boolean prepareConfigurationRequired;
	protected boolean configurationUpdated;
	...
	@Override
	public void setPrepareConfigurationRequired(final boolean prepareConfigurationRequired)
	{
		this.prepareConfigurationRequired = prepareConfigurationRequired;
	}
	...
	@Override
	public void setConfigurationUpdated(final boolean configurationUpdated)
	{
