		...
		TransactionConfigurationBackend
{
	...
	/**
	 * @return Is FM {@link TransactionConfigurationBase#RFC_NAME_LANGUAGE_SWITCH_DELIV_CUSTOMIZING} available?
	 */
	...
	/**
	 * Get cached delivery types via newly introduced FM
	 * {@link TransactionConfigurationBase#RFC_NAME_LANGUAGE_SWITCH_DELIV_CUSTOMIZING}. If nothing is part of the cache
	 * yet, backend will be invoked.
	 * 
	...
	/**
	 * Get delivery types from backend via newly introduced FM
	 * {@link TransactionConfigurationBase#RFC_NAME_LANGUAGE_SWITCH_DELIV_CUSTOMIZING}.
	 * 
	 * @return Map of delivery types with code as key and language dependent description as value
	 */
