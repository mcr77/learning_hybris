...
public class SearchBackendERP extends BackendBusinessObjectBaseJCo implements SearchBackend
{
	 ...
	 * 
	 */
	private static final String ERP_ISA_GEN_DOCUMENT_SEL = "ERP_ISA_GEN_DOCUMENT_SEL";
	...
	public int getDateRangeInDays()
	{
		...
		{
			dateRangeInDays = Integer.valueOf((String) moduleConfigurationAccess
	 ...
	 * 
	 * @see
	 * de.hybris.platform.sap.sapordermgmtbol.transaction.salesdocument.search.backend.interf.SearchBackend#getSearchResult
	 * ()
	 */
	@Override
	...
	protected void performLogging(final SearchResultList resultList, final int maxHits)
	{
		...
		{
			sapLogger
					.log(Severity.WARNING, LogCategories.APPLICATIONS, "Result list size exceeds 90% of the maximum number of hits");
		}
	}
	...
	protected int getMaxHits()
	{
		if (maxHits == null)
		{
			maxHits = Integer.valueOf((String) moduleConfigurationAccess
