...
public class CheckoutConfigurationBackendTools
{
	 ...
	 */
	public HashMap<String, String> executeSearchhelp(final JCoConnection jConn, final String searchhelp, final String valueField,
	 ...
	 * @return a HashMap with pairs ( content of the valuefield, content of the descriptionfield)
	 */
	protected HashMap<String, String> convertSearchResult(final JCoParameterList jTableParams, final String valueField,
			final String descriptionField, final boolean withFallbackDesc)
	{
		...
		for (int i = 0; i < jFieldList.getNumRows(); i++)
		{
			...
			if (intDescriptionFieldEnd > 0)
			{
				...
				{
					stringDescription = stringHelpvalues.substring(intDescriptionFieldOffset, strlenFieldEnd);
				}
				if (withFallbackDesc)
				{
