...
public class SearchResultComparator implements Comparator<SearchResult>
{
	...
	{
		//		final Class<SearchResult> searchClass = SearchResult.class;
		//		try
		//		{
		//			searchClass.getField(sortCode);
		//		}
		//		catch (final NoSuchFieldException e)
		//		{
		//			throw new ApplicationBaseRuntimeException("Invalid order sort code provided: " + sortCode);
		//		}
