 ...
 */
public final class SapordermgmtservicesConstants extends GeneratedSapordermgmtservicesConstants
{
	public static final String EXTENSIONNAME = "sapordermgmtservices";
	public static final String ALIAS_CART_POPULATOR = "sapordermgmtCartPopulator";
	public static final String ALIAS_ABSTRACT_ORDER_POPULATOR = "sapordermgmtAbstractOrderEntryPopulator";
