...
public class DefaultAbstractOrderPopulatorTest
{
	...
	private final DefaultAbstractOrderPopulator classUnderTest = new DefaultAbstractOrderPopulator();
	...
	public static void injectMockedBeans(final DefaultAbstractOrderPopulator populator)
	{
		...
		EasyMock.expect(baseSiteModel.getName()).andReturn(" ");
	...
	private void setupAndAddItem(final Basket source)
	{
		...
		source.getItemList().add(new ItemSalesDoc());
	}
	...
	public void testPopulateDeliveryAddress()
	{
		...
		final Converter addressConverterMock = EasyMock.createNiceMock(Converter.class);
