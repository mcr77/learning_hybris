...
<div  class="total">
	<spring:theme code="popup.cart.total"/>&nbsp;<span class="right"><format:price priceData="${cartData.subTotal}"/></span>
 	<div class="small">
		<spring:theme code="sap.cart.excludingTaxesAndShippingCosts" />
	</div>
</div>
