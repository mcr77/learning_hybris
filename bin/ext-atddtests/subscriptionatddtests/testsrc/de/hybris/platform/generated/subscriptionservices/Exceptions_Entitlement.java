...
@IntegrationTest
public class Exceptions_Entitlement extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("Exceptions_Entitlement-log");
			robotSettings.setOutputName("Exceptions_Entitlement-output");
			robotSettings.setReportName("Exceptions_Entitlement-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/home/bamboouser/agent/agent-home/xml-data/build-dir/HYM-SUB3-JOB1/source/subscriptionatddtests/genresources/robottests/Exceptions_Entitlement.txt"));
		}
	...
	@Test
	public void Test_Exceptions_Entitlement_Add_Metered_Twice()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Exceptions_Entitlement_Add_Metered_Twice";
	...
	@Test
	public void Test_Exceptions_Entitlement_Add_Metered_UsageUnitMinute_DifferentQuantity_x2()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Exceptions_Entitlement_Add_Metered_UsageUnitMinute_DifferentQuantity_x2";
	...
	@Test
	public void Test_Exceptions_Entitlement_Add_Metered_UsageUnitMinute_DifferentQuantity_x3()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Exceptions_Entitlement_Add_Metered_UsageUnitMinute_DifferentQuantity_x3";
	...
	@Test
	public void Test_Exceptions_Entitlement_Add_Metered_UsageUnitMinute_SameQuantity_x2()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Exceptions_Entitlement_Add_Metered_UsageUnitMinute_SameQuantity_x2";
	...
	@Test
	public void Test_Exceptions_Entitlement_Add_Metered_UsageUnitMinute_SameQuantity_x3()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Exceptions_Entitlement_Add_Metered_UsageUnitMinute_SameQuantity_x3";
	...
	@Test
	public void Test_Exceptions_Entitlement_Add_Metered_UsageUnitMinuteText_DifferentQuantity_x3()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Exceptions_Entitlement_Add_Metered_UsageUnitMinuteText_DifferentQuantity_x3";
	...
	@Test
	public void Test_Exceptions_Entitlement_Add_Metered_UsageUnitMinuteText_DifferentQuantity_x4()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Exceptions_Entitlement_Add_Metered_UsageUnitMinuteText_DifferentQuantity_x4";
	...
	@Test
	public void Test_Exceptions_Entitlement_Add_Metered_UsageUnitMinuteText_SameQuantity_x4()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Exceptions_Entitlement_Add_Metered_UsageUnitMinuteText_SameQuantity_x4";
	...
	@Test
	public void Test_Exceptions_Entitlement_Add_Non_Metered_Twice()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Exceptions_Entitlement_Add_Non_Metered_Twice";
	...
	@Test
	public void Test_Exceptions_Entitlement_Add_Non_Metered_x2()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Exceptions_Entitlement_Add_Non_Metered_x2";
	...
	@Test
	public void Test_Exceptions_Entitlement_Add_Non_Metered_x3()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Exceptions_Entitlement_Add_Non_Metered_x3";
	...
	@Test
	public void Test_MeteredEntitlement_with_timeUnits()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_MeteredEntitlement_with_timeUnits";
	...
	@Test
	public void Test_NonMeteredEntitlement_with_timeUnits()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_NonMeteredEntitlement_with_timeUnits";
	...
	@Test
	public void Test_MeteredEntitlement_with_emptyTimeUnits()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_MeteredEntitlement_with_emptyTimeUnits";
