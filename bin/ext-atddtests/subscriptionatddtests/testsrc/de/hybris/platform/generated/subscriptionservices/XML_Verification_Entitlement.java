...
@IntegrationTest
public class XML_Verification_Entitlement extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("XML_Verification_Entitlement-log");
			robotSettings.setOutputName("XML_Verification_Entitlement-output");
			robotSettings.setReportName("XML_Verification_Entitlement-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/home/bamboouser/agent/agent-home/xml-data/build-dir/HYM-SUB3-JOB1/source/subscriptionatddtests/genresources/robottests/XML_Verification_Entitlement.txt"));
		}
	...
	@Test
	public void Test_XML_Verification_Entitlement_Meteredx1()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_XML_Verification_Entitlement_Meteredx1";
	...
	@Test
	public void Test_XML_Verification_Entitlement_Meteredx2()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_XML_Verification_Entitlement_Meteredx2";
	...
	@Test
	public void Test_XML_Verification_Entitlement_NonMeteredx1()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_XML_Verification_Entitlement_NonMeteredx1";
	...
	@Test
	public void Test_XML_Verification_Entitlement_NonMeteredx2()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_XML_Verification_Entitlement_NonMeteredx2";
	...
	@Test
	public void Test_XML_Verification_Entitlement_Meteredx1_NonMeteredx1()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_XML_Verification_Entitlement_Meteredx1_NonMeteredx1";
	...
	@Test
	public void Test_XML_Verification_Entitlement_Meteredx2_NonMeteredx1()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_XML_Verification_Entitlement_Meteredx2_NonMeteredx1";
	...
	@Test
	public void Test_XML_Verification_Entitlement_Meteredx1_NonMeteredx2()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_XML_Verification_Entitlement_Meteredx1_NonMeteredx2";
	...
	@Test
	public void Test_XML_Verification_Entitlement_Meteredx2_NonMeteredx2()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_XML_Verification_Entitlement_Meteredx2_NonMeteredx2";
	...
	@Test
	public void Test_XML_Verification_Entitlement_Meteredx2_TimeUnits()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_XML_Verification_Entitlement_Meteredx2_TimeUnits";
