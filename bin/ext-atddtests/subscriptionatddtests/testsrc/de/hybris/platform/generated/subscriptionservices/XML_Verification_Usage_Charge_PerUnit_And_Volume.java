	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/home/bamboouser/agent/agent-home/xml-data/build-dir/HYM-SUB3-JOB1/source/subscriptionatddtests/genresources/robottests/XML_Verification_Usage_Charge_PerUnit_And_Volume.txt"));
		}
