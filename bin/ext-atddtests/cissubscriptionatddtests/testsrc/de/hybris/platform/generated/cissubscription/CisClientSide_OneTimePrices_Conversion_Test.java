	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/home/bamboouser/agent/agent-home/xml-data/build-dir/HYM-SUB3-JOB1/source/cissubscriptionatddtests/genresources/robottests/CisClientSide_OneTimePrices_Conversion_Test.txt"));
		}
