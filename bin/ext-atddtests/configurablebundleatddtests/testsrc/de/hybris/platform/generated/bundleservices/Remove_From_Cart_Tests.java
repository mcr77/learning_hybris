	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/home/bamboouser/agent/agent-home/xml-data/build-dir/HYM-BUNDLE3-JOB1/source/configurablebundleatddtests/genresources/robottests/Remove_From_Cart_Tests.txt"));
		}
