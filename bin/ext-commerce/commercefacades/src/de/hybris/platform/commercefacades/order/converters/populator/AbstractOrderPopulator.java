		...
		Populator<SOURCE, TARGET>
{
	...
	private final Map<String, PriceData> priceDatas = new HashMap<String, PriceData>();
	...
	protected void addDeliveryMethod(final AbstractOrderModel source, final AbstractOrderData prototype)
	{
		...
		if (deliveryMode != null)
		{
			...
			if (deliveryMode instanceof ZoneDeliveryModeModel)
			{
				...
				final PriceValue deliveryCost = getDeliveryService().getDeliveryCostForDeliveryModeAndAbstractOrder(deliveryMode,
						source);
	...
	protected PriceData createZeroPrice()
	{
		...
		if (priceDatas.containsKey(key))
		{
			return priceDatas.get(key);
		}
		else
		{
