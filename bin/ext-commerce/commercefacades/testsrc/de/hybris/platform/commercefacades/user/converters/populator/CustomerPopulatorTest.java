...
public class CustomerPopulatorTest
{
	...
	public void setUp()
	{
		...
		customerPopulator.setAddressConverter(addressConverter);
	...
	public void testConvertAll()
	{
		...
		given(userModel.getDefaultPaymentAddress()).willReturn(addressModel);
		given(userModel.getDefaultShipmentAddress()).willReturn(addressModel);
		...
		Assert.assertEquals(addressData, customerData.getDefaultBillingAddress());
		Assert.assertEquals(addressData, customerData.getDefaultShippingAddress());
