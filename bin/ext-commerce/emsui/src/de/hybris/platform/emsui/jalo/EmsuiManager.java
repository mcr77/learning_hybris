 ...
 *  
 */
package de.hybris.platform.emsui.jalo;
...
import de.hybris.platform.emsui.constants.EmsuiConstants;



/**
 * This is the extension manager of the Emsui extension.
 */
public class EmsuiManager extends GeneratedEmsuiManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(EmsuiManager.class.getName());
	 ...
	 */
	public static EmsuiManager getInstance()
	{
		return (EmsuiManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				EmsuiConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public EmsuiManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of EmsuiManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of EmsuiManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of EmsuiManager called, current tenant: " + getTenant().getTenantID());
		}
	}
