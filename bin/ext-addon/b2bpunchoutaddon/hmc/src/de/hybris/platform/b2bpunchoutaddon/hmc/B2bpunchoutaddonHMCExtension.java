 ...
 *  
 */
package de.hybris.platform.b2bpunchoutaddon.hmc;
...
/**
 * Provides necessary meta information about the b2bpunchoutaddon hmc extension.
 * 
 * 
 * @version ExtGen v5.1.0.0-SNAPSHOT
 */
public class B2bpunchoutaddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(B2bpunchoutaddonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "de.hybris.platform.b2bpunchoutaddon.hmc.locales";
