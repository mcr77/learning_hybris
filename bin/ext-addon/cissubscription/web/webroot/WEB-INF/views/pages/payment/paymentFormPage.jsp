		...
		<form:form method="post" commandName="paymentForm" action="${sopMockUrl}">
			...
			<div>
				<table>
					...
					<tr>
						<td><form:label path="billingAddress.firstName"><spring:message code="billingAddress.name.label"/></form:label></td>
						<td><form:input path="billingAddress.firstName"/></td> 
					</tr>
					<tr>
						<td><form:label path="billingAddress.lastName"><spring:message code="billingAddress.name.label"/></form:label></td>
