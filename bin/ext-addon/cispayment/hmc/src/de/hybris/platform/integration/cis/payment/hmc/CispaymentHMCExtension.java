...
/**
 * Provides necessary meta information about the cispayment hmc extension.
 * 
 * @version ExtGen v4.1
 */
public class CispaymentHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(CispaymentHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "de.hybris.platform.integration.cis.payment.hmc.locales";
