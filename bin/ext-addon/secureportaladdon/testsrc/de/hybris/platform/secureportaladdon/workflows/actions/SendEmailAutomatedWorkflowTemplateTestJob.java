 ...
 */
public class SendEmailAutomatedWorkflowTemplateTestJob<PROCESS extends B2BRegistrationProcessModel> extends
		AbstractAutomatedWorkflowTemplateJob
{

	private static final Logger LOG = Logger.getLogger(SendEmailAutomatedWorkflowTemplateTestJob.class);
	...
	{
		return getProcessDefinitionName() + "-" + customerModel.getUid();
	}
