 ...
 *  
 */
package de.hybris.platform.secureportaladdon.hmc;
...
/**
 * Provides necessary meta information about the secureportaladdon hmc extension.
 * 
 * 
 * @version ExtGen v5.1.1.0
 */
public class SecureportaladdonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(SecureportaladdonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "de.hybris.platform.secureportaladdon.hmc.locales";
