...
public class FraudMockClientTest extends ServicelayerTest
{
	...
	public void setUp()
	{
		final GenericMockFactory fraudClientFactory = (GenericMockFactory) Registry.getApplicationContext().getBean(
				"&fraudClientFactory");
		fraudClientFactory.setMockMode(true);

		fraudClient = (FraudClient) fraudClientFactory.getObject();
	}
