 ...
 *  
 */
package com.hybris.cis.client.jalo;
...
import com.hybris.cis.client.constants.CisclienttestConstants;



/**
 * This is the extension manager of the Cisclienttest extension.
 */
public class CisclienttestManager extends GeneratedCisclienttestManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CisclienttestManager.class.getName());
	 ...
	 */
	public static CisclienttestManager getInstance()
	{
		return (CisclienttestManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CisclienttestConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CisclienttestManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CisclienttestManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CisclienttestManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CisclienttestManager called, current tenant: " + getTenant().getTenantID());
		}
	}
