...
import de.hybris.platform.commercewebservicescommons.errors.converters.AbstractLocalizedErrorConverter;
...
/**
 * Converts {@link CartModificationData} to a list of {@link de.hybris.platform.commercewebservicescommons.dto.error.ErrorWsDTO}.
 */
public class CartModificationDataErrorConverter extends AbstractLocalizedErrorConverter
{
	...
	public void populate(final Object o, final List<ErrorWsDTO> webserviceErrorList)
	{
		...
		if (cartModification.getStatusCode() == CommerceCartModificationStatus.NO_STOCK)
		{
