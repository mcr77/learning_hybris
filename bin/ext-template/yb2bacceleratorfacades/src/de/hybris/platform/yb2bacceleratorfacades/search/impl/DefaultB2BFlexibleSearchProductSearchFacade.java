...
import de.hybris.platform.yb2bacceleratorfacades.search.converters.impl.DefaultB2BFlexibleSearchConverter;
		...
		AbstractB2BProductSearchFacade<ProductData>
{
			...
			final PageableData pageableData, final Collection<ProductOption> options, final boolean populateMatrix)
	{
		...
		getFlexibleSearchConverter().setOptions(options);
		getFlexibleSearchConverter().setSkus(skus);
