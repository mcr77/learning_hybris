 ...
 *  
 */
package de.hybris.platform.yb2bacceleratorcore.hmc;
...
/**
 * Provides necessary meta information about the yb2bacceleratorcore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class YB2BAcceleratorCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(YB2BAcceleratorCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "de.hybris.platform.yb2bacceleratorcore.hmc.locales";
