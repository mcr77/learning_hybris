...
class CartMatchingFilterTests extends BaseWSTest {
	...
	void testAnonymousUserOtherCart() {
		def access_token1 = testUtil.getAccessToken(uid1, PASSWORD, testUtil.TRUSTED_CLIENT_ID, testUtil.TRUSTED_CLIENT_SECRET)
		CartTests cartTests = new CartTests();
	...
	void testExistingCustomerCart() {
		def access_token = testUtil.getAccessToken(uid1, PASSWORD, testUtil.TRUSTED_CLIENT_ID, testUtil.TRUSTED_CLIENT_SECRET)
		CartTests cartTests = new CartTests();
	...
	void testOtherUsersCart() {
		...
		def access_token2 = testUtil.getAccessToken(uid2, PASSWORD, testUtil.TRUSTED_CLIENT_ID, testUtil.TRUSTED_CLIENT_SECRET)
