...
class UserMatchingFilterTests extends BaseWSTest {
	...
	void testMatchingPathForAuthenticatedCustomer() {
		def access_token = testUtil.getAccessToken(uid, "test", testUtil.TRUSTED_CLIENT_ID, testUtil.TRUSTED_CLIENT_SECRET)
	...
	void testNotMatchingPathForClient() {
		def client_access_token = testUtil.getClientCredentialsToken(testUtil.CLIENT_ID, testUtil.CLIENT_SECRET)
