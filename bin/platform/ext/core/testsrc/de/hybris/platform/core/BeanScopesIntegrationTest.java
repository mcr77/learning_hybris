...
public class BeanScopesIntegrationTest extends HybrisJUnit4Test
{
	...
	public void testBeanReferencesComparisonAfterTenanChange() throws Exception
	{
		...
		{
			final Object tenantScopedBean1 = Registry.getApplicationContext().getBean(MODEL_SERVICE);
			final Object globalScopedBean1 = Registry.getApplicationContext().getBean(GLOBAL_SINGLETON_BEAN);
			...
			try
			{
				...
				final Object tenantScopedBean2 = Registry.getApplicationContext().getBean(MODEL_SERVICE);
				final Object globalScopedBean2 = Registry.getApplicationContext().getBean(GLOBAL_SINGLETON_BEAN);
