...
<head>
    ...
    <link rel="stylesheet" href="<c:url value="/static/css/plugins/buttons/screen.css"/>" type="text/css"
          media="screen, projection"/>
    <link rel="stylesheet" href="<c:url value="/static/css/custom-theme/jquery-ui-1.8.12.custom.css"/>" type="text/css"
          media="screen, projection"/>
...
<footer>
    <a id="about" data-aboutUrl="<c:url value="/platform/about"/>" href="#">&copy; hybris AG, 2013</a>
</footer>
