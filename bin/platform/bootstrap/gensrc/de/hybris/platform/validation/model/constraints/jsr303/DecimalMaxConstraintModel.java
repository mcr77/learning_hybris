...
public class DecimalMaxConstraintModel extends AttributeConstraintModel
{
	...
	/** <i>Generated variable</i> - Variable of <code>DecimalMaxConstraint.value</code> attribute defined at extension <code>validation</code>. */
	 ...
	 */
	@Deprecated
	public DecimalMaxConstraintModel(final String _id, final BigDecimal _value)
	{
		super();
		setId(_id);
		setValue(_value);
	 ...
	 */
	@Deprecated
	public DecimalMaxConstraintModel(final String _id, final ItemModel _owner, final BigDecimal _value)
	{
		super();
		setId(_id);
		setOwner(_owner);
