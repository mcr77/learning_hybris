...
public class ComponentModel extends ItemModel
{
	...
	{
		return getPersistenceContext().getLocalizedValue(CREATEPERMITTED, loc);
	}
	...
	{
		return getPersistenceContext().getLocalizedValue(READPERMITTED, loc);
	}
	...
	{
		return getPersistenceContext().getLocalizedValue(REMOVEPERMITTED, loc);
	}
	...
	{
		return getPersistenceContext().getLocalizedValue(WRITEPERMITTED, loc);
	}
