 ...
 */
package de.hybris.platform.integration.cis.sampledata.event;

import de.hybris.platform.commerceservices.setup.events.SampleDataImportedEvent;
import de.hybris.platform.integration.ondemand.sampledata.event.OndemandSampleDataSystemSetup;
...
public class SampleDataImportedEventListener extends AbstractEventListener<SampleDataImportedEvent>
{
	...
	protected void onEvent(final SampleDataImportedEvent event)
	{
		...
		getOndemandSampleDataSystemSetup().importSampleData("cissampledata", event.getContext(), event.getImportData());
	}
