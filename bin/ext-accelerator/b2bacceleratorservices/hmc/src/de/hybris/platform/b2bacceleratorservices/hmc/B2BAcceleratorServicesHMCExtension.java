 ...
 *  
 */
package de.hybris.platform.b2bacceleratorservices.hmc;
...
/**
 * Provides necessary meta information about the b2bacceleratorservices hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class B2BAcceleratorServicesHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(B2BAcceleratorServicesHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "de.hybris.platform.b2bacceleratorservices.hmc.locales";
